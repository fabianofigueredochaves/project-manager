...
public class FrmGerUsuario extends javax.swing.JFrame {
    
      
    List<Usuarios> allColumnsUsuarios = new ArrayList<>();    
    
    public FrmGerUsuario() throws SQLException {       
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmGerUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmGerUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new FrmGerUsuario().setVisible(true);
            } catch (SQLException ex) {
                Logger.getLogger(FrmGerUsuario.class.getName()).log(Level.SEVERE, null, ex);
            }
        });
