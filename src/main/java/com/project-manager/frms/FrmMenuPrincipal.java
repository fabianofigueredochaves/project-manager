...
public class FrmMenuPrincipal extends javax.swing.JFrame {
    ...
    private void btnVisProjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVisProjActionPerformed
        ...
        FrmMenuPrincipal.nomeProjeto = (String)(tblProjetos.getValueAt((tblProjetos.getSelectedRow()), 1));
        
        FrmMenuPrincipal.idProjeto = (int)(tblProjetos.getValueAt((tblProjetos.getSelectedRow()), 0));
        
        System.out.println("Nome do projeto: " + FrmMenuPrincipal.nomeProjeto);
