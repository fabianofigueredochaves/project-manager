...
public class FrmCadUsuarios1 extends javax.swing.JFrame {

    Usuarios usuario;
    
    public FrmCadUsuarios1() {
    ...
    private void btnFecharActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFecharActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmCadUsuarios1.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmCadUsuarios1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new FrmCadUsuarios1().setVisible(true);
        });
    }
